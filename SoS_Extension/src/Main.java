...
//
            ...
            File batch_im = new File(base + "/SoS_Extension/results/" + "F1P - HyperparameterAnalysis_Base_6.txt");
            try {
...
//                folder2.mkdir();
                if (!single) {
                    File file2 = new File(base + "/SoS_Extension/results/" + "F1P - HyperparameterAnalysis_Base_6.csv");  // TODO Which Case? -> File Name Change
